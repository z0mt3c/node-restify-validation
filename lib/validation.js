...
module.exports.getValidatorChain = function (key, validationRules, validationModel, req, options, recentErrors) {
...
module.exports.validateAttribute = function (key, validationRules, validationModel, req, options, recentErrors) {
    var validatorChain = this.getValidatorChain(key, validationRules, validationModel, req, options, recentErrors);
    var self = this;
...
module.exports.process = function (validationModel, req, options) {
    ...
    _.each(validationModel, function (validationRules, key) {
        var error = self.validateAttribute(key, validationRules, validationModel, req, options, errors);
